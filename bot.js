...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' $help','99 system','By 88 ','99 system',' $help'];
    var i = -1;
    var j = 0;
...
client.on('message', message => {
  ...
  client.channels.get("474354424391663616").send(
      "\n" + "**" + "● اقتراحات سيرفر :" + "**" +
      "\n" + "**" + "» " + message.guild.name + "**" +
      "\n" + "**" + " ● مرسل الاقتراح : " + "**" +
      "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', async message => {//alpha codes & Mrx -Dev
                    if (message.content.startsWith('$add.role')) {//alpha codes & Mrx -Dev
...
client.on("message", message => {
    if(message.content.startsWith(prefix + 'rome')) {
     let args = message.content.split(" ").slice(1);
      ...
      message.guild.createChannel(nam, 'voice').then(c => setTimeout(() => c.delete(), 1200000)) // كل 60 تساوي دقيقة عدل عليها الوقت لي تبيه 
      message.channel.send(`:ballot_box_with_check: TemporarySound : \`${nam}\``).then(c => setTimeout(() => c.edit(`<@${message.author.id}> :stopwatch:  انتهى وقت الروم الصوتي`), 1200000))  // 1200000 دقيقتان
    }
    });
